...
```
npm create cloudflare@latest -- --template=cloudflare/templates/shiny-frog-6ffd
```

## Preview Deployment

A live public deployment of this template is available at [https://shiny-frog-6ffd.templates.workers.dev](https://shiny-frog-6ffd.templates.workers.dev)
